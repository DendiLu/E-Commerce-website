...
public class SkuSearchServiceImpl implements SkuSearchService {
    ...
    public Map search(Map<String, String> searchMap) {
        ...
        //聚合查询（商品分类）
        TermsAggregationBuilder terms = AggregationBuilders.terms("sku_category").field("categoryName");
        SearchSourceBuilder aggregation = searchSourceBuilder.aggregation(terms);
        ...
        try {
            ...
            Terms termsResult = (Terms) asMap.get("sku_category");
    ...
    public Map search2(Map<String,String> searchMap) {
        ...
        try {
            ...
            //2.5 页码
            long totalCount = searchHits.getTotalHits().value;  //总记录数
